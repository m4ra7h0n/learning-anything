package com.xjjlearning.springframework.security.controller;
...
public class FooController {
     ...
     */
    @GetMapping("/foo/bar")
    public Map<String,Object> bar(@RegisteredOAuth2AuthorizedClient("xjj") OAuth2AuthorizedClient client){
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
