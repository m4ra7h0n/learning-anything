...
class DbUtils {
    ...
    private static final String url = "jdbc:db2://127.0.0.1:50000/testdb";
...
public class xjj0713pic
{
    private JFrame frame = new JFrame("55180713 肖子健");
    ...
    {
        createDir("/Users/xjj/IdeaProjects/learning-anything/learning-database/learning-database-db2/src/main/resources/output_pic");
        ...
        jf.getContentPane().add(new JLabel("请注意：查询结果图片将会输出到 resource/output_pic 文件夹中..."));
        jf.setVisible(true);
        jb.addActionListener(new ActionListener() {//查询按钮
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String sql = "select picture from UDBA.EMP_PHOTO where ID=?";
                    ...
                    File fileOutput = new File("/Users/xjj/IdeaProjects/learning-anything/learning-database/learning-database-db2/src/main/resources/output_pic/output_" + number + ".jpg");
                    FileOutputStream fo = new FileOutputStream(fileOutput);
                    int c;
                    while((c = inputStream.read()) != -1)
                        fo.write(c);
                    fo.close();
                    JOptionPane.showMessageDialog(null,"图片已经输出到resource/output_pic文件夹中！");
                    rs.close();
                } catch(Exception ee) {
    ...
    private void function2()//插入页面
    {
        ...
        JLabel IDlabel = new JLabel("请输入图片");
        ...
        jb_ok.addActionListener(new ActionListener() {//插入按钮
            public void actionPerformed(ActionEvent e) {
                ...
                String path = "/Users/xjj/IdeaProjects/learning-anything/learning-database/learning-database-db2/src/main/resources/input_pic/" + jt_path.getText();
                try{
                    String sql = "insert into UDBA.EMP_PHOTO values(?, 'bitmap', ?)";
                    Connection conn = null;
                    PreparedStatement ps = null;
                    conn = DbUtils.getConnection();
                    ps = conn.prepareStatement(sql);
